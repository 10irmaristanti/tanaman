      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tambah Data Tanaman</h1>
          </div>
                  ...
                  <table class="table align-items-center table-flush">
                    <thead class="thead-light">
                      ...
                      <?php 
                          ...
                          if(isset($_GET['cari'])){
                              $cari = $_GET['cari'];
                              $query = mysqli_query($connect,"SELECT * FROM crud WHERE nama LIKE '%".$cari."%' OR nik LIKE '%".$cari."%'" ); 
                            }
                              else{
                          ...
                          ?> 
                            <tr>
                              ...
                              <td>
                                <a class="btn btn-sm btn-primary" href="form_editData.php?id_crud=<?php echo $data['id_crud']; ?>">Edit</a> 
                                <a class="btn btn-sm btn-primary" href="deleteData.php?id_crud=<?php echo $data['id_crud']; ?>" onclick="return confirm()">Hapus</a>
